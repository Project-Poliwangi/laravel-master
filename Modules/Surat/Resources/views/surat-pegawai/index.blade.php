    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ url('/surat/arsip/create') }}" type="button" class="btn btn-sm btn-primary waves-effect waves-light mb-3">
                        <i class="fa fa-plus" aria-hidden="true"></i> Tambah Surat</a>
