                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <th>Induk</th>
                                    <td>{{ $surat_dispo->surat_masuk->induk }}</td>
                                </tr>
                                <tr>
                                    <th>Nomor Surat</th>
                                ...
                                <tr>
                                    <th>Surat</th>
                                    <td><a href="" title="Download file"><button class="btn btn-warning btn-sm"><i class="fas fa-cloud-download-alt" aria-hidden="true"></i> Download</button></a>
                                        <a title="Lihat File"><button class="btn btn-primary btn-sm"><i class="fas fa-eye" aria-hidden="true"></i> Lihat File</button></a></td>
                                </tr>
