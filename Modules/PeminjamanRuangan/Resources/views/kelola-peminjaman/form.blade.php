...
@section('content')
    ...
    <div class="col-md-5 col-sm-10 col-12">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('kelola-peminjaman.update', $data->id)}}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select name="program_studi_id" class="form-control @error('program_studi_id') is-invalid @enderror" readonly>
                            <option value=""></option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="mata_kuliah_id" class="form-control @error('mata_kuliah_id') is-invalid @enderror" readonly>
                            <option value=""></option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="dosen_id" class="form-control @error('dosen_id') is-invalid @enderror" readonly>
                            <option value=""></option>
                    ...
                    <div class="form-group">
                        <label for="">NIM</label>
                        <input type="text" name="nim" class="form-control @error('nim') is-invalid @enderror" value="{{ old('nim', isset($data) ? $data->peminjam_nim : '') }}" readonly>
                        @error('nim')
                            <i class="text-danger small mx-2">{{ $message }}</i>
                        @enderror
                    </div>
