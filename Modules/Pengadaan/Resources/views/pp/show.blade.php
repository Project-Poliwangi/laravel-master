        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center border-bottom bg-dark">
                    ...
                    <a href="{{ url('/pp/daftarpengadaan') }}" title="Back" class="btn btn-primary btn-sm rounded-pill shadow-sm" style="margin-left:auto;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="tableDetail">
                            <tbody>
                                ...
                                <tr>
                                    <th class="bg-light"  style="width: 30%; vertical-align: middle;">Pejabat Pembuat Komitmen (PPK)</th>
                                    <td>
