                        ...
                        <table id="myTable" class="table table-striped table-bordered">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th><input type="text" placeholder="Jenis Pengadaan"
                                            class="form-control text-center"></th>
                                    <th>
                            ...
                            <tbody>
                                @foreach ($subPerencanaan as $pp)
                                    @if ($pp->pengadaan)
                                        @php
                                            $pp->pengadaan->checkAndUpdateStatus();
                                        @endphp
                                    @endif
                                    <tr>
                                        <td class="text-center">{{ $loop->iteration }}</td>
                                        <td class="text-left">{{ $pp->kegiatan }}</td>
                                        <td class="text-center">
                                            @if ($pp->metodePengadaan)
                                                {{ $pp->metodePengadaan->nama_metode }}
                                            @else
                                                <em>Metode belum tersedia</em>
                                            @endif
                                        </td>
                                        <td class="text-center">
                                            @if ($pp->jenisPengadaan)
                                                {{ $pp->jenisPengadaan->nama_jenis }}
                                            @else
                                                <em>Jenis belum tersedia</em>
                                            @endif
                                        </td>
                                        <td class="text-center">
                                            @php
                                                ...
                                                if ($pp->pengadaan && $pp->pengadaan->status) {
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                <button onclick="window.location.href='{{ url('/pp/show/' . $pp->id) }}'"
