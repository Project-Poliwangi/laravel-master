                        ...
                        <table class="table table-borderless" id="tableDetail">
                            <tbody>
                                ...
                                <tr>
                                    <th>Catatan</th>
                                    <td>
                                        @if ($subPerencanaan->pengadaan && $subPerencanaan->pengadaan->status->nama_status == 'Pemenuhan Dokumen')
                                            <div class="alert alert-info mb-0">
                                                {{ $subPerencanaan->pengadaan ? $subPerencanaan->pengadaan->catatan : 'Tidak ada catatan' }}
                                            </div>
                                        @else
                                ...
                                {{-- <tr>
                                        ...
                                        <td>
                                            @if (!in_array($subPerencanaan->pengadaan->status->nama_status, ['Kontrak', 'Serah Terima']))
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (!in_array($subPerencanaan->pengadaan->status->nama_status, ['Serah Terima']))
                                                <a href="{{ asset('storage/' . $subPerencanaan->pengadaan->dokumen_pemilihan_penyedia) }}"
                                                    target="_blank">{{ $subPerencanaan->pengadaan->dokumen_pemilihan_penyedia }}</a>
                                            @else
                                                <p>Tidak ada dokumen</p>
